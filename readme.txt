...
The next item is the TypeID. This is the typeID of the item in question. In the above, we use 272 because that us the ID of the stone Sword.
...
Invisibility is unfortunately not available yet. *It will be added when I rewrite the potion randomizing code to use the recently added ItemMeta classes*
