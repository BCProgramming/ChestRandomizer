	...
	public final static String PluginName="BCRandomizer";
	  ...
	  //Another idea is to allow that to be changed via other commands, possibly referring to files in the plugin folder.
	   ...
	   // public GameTracker _Tracker = null;
		...
		private static HashMap<String,String> HolidayLookup = null; //we use locale-inspecific method, MM/DD
		...
		public static String getHoliday(Calendar cal){
			...
			String uselookup = cal.get(Calendar.MONTH) + "/" + cal.get(Calendar.DAY_OF_MONTH);
